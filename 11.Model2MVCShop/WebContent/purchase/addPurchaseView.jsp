	...
	<div class="container">
	    ...
	    <div class="col-md-4">
		 ...
		 <div class="row" style="height: 10px">
	  		<div class="col-xs-6 col-md-4"><small><strong>상품번호</strong></small></div>
			<div class="col-xs-8 col-md-8"><small>${pvo.prodNo}</small></div>
		</div>

		<hr/>
		<div class="row" style="height: 10px">
	  		<div class="col-xs-6 col-md-4"><small><strong>상품명</strong></small></div>
			<div class="col-xs-8 col-md-8"><small>${pvo.prodName}</small></div>
		</div>	
		<hr/>
		
		<div class="row" style="height: 10px">
	  		<div class="col-xs-6 col-md-4"><small><strong>상품상세정보</strong></small></div>
			<div class="col-xs-8 col-md-8"><small>${pvo.prodDetail}</small></div>
		</div>	
		<hr/>
		
		<div class="row" style="height: 10px">
	  		<div class="col-xs-6 col-md-4"><small><strong>제조일자</strong></small></div>
			<div class="col-xs-8 col-md-8"><small>${pvo.manuDate}</small></div>
		</div>	
		<hr/>
		
		<div class="row" style="height: 10px">
	  		<div class="col-xs-6 col-md-4"><small><strong>가격</strong></small></div>
